...
def conversation_1():
    ...
    if choice_1 == "1":#the town
       # time.sleep(1)
        ...
        #time.sleep(4)
        print "'You were pretty beat up, bruises and cuts all over your body. It looks like you took a fall from an airplane.'"
        #time.sleep(4)
        print ""
        print "'An airplane?' you question."
        #time.sleep(3)
        print ""
        print "'Right, it's a surprise to us too, airplanes don't usually fly over here. They tend to avoid us at all times.'"
        #time.sleep(5)
...
def conversation_5():#progresses##text for arlo's tour
    print ""
    ...
    #time.sleep(3)
    print ""
    print "The two of you walk out of the hospital you had been staying in."
    #time.sleep(3)
    print "Looking around, you realize how worn down the town has become."
    #time.sleep(2.5)
    print "No trees in sight, a layer of smog above the city, and piles of rubble which once were houses and stores."
    #time.sleep(4)
    print "Standing just outside of the hospital Arlo speaks to you."
    #time.sleep(2)
    print ""
    print "'There are three people I want you to meet,' Arlo explains,"
    #time.sleep(2.5)
    print "'Buffy Aiden the shopkeep, Julius Fletcher the scientist, and Evie Rupert.'"
    #time.sleep(3)
    print "'Evie is the one who found you and called for help. You should go and thank her.'"
    #time.sleep(4)
    print ""
...
def conversation_7():#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@LITERALLY ALL OF THE STORY
    ...
    if choice_5 == "1":#choose Buffy
        print ""
        print "'I think I would like to go see Buffy first.' you decide."
        time.sleep(2)
        ...
        print ""
        print "'Julius sounds like an interesting person,' you say,"
        time.sleep(2)
        print "'I would like to see him first.'"
        time.sleep(2)
        ...
        print ""
        print "'I guess I should go thank Evie for helping me,' you say,"
        time.sleep(2)
        print "'I think I want to see her first.'"
        time.sleep(2)
...
def conversation_8():
            print "'Who do you want to see next?'"
            choice_6 = raw_input(" : Julius Fletcher... [1], Evie Rupert... [2] : ")
            if choice_6 == "1":
                print ""
                print "'I think I would like to go see Julius next please.' you decide."
                time.sleep(3)
                ...
                print ""
                print "'I think I should go see Evie now and thank her.' you say."
                time.sleep(3)
...
def conversation_9():
            ...
            if choice_7 == "1":
                print ""
                print "'I want to see what Buffy is up to.' you say."
                time.sleep(3)
...
def conversation_11():
    ...
    if choice_9 == "1":
        print ""
        print "'I guess that leaves Buffy.' you say."
        time.sleep(2)
...
def conversation_12():
    ...
    if choice_10 == "1":
        print ""
        print "'I guess that leaves Julius.' you say."
        time.sleep(2)
...
def conversation_13():
    ...
    if choice_11 == "1":
        print ""
        print "'I guess that leaves Evie.' you say."
        time.sleep(2)
...
def conversation_14(choice_5, choice_7, choice_8):#Buffy Aiden path ##timers
    print ""
    print "'Great! We'll go head over to Buffy's store now.' Arlo says."
    time.sleep(3.5)
    print ""
    print "As you are walking, Arlo begins to explain a little bit about Buffy."
    time.sleep(3.5)
    print ""
    print "'Buffy is an old timer,' he says,"
    time.sleep(2.5)
    print "'he's been around Pitterton longer than anyone else.'"
    time.sleep(3.5)
    print "'He is also the town's center of news coming from the outside world.' Arlo continues."
    time.sleep(4.5)
    print "'If you want to know anything, Buffy is the first person to ask!'"
    time.sleep(3.5)
    print ""
    print "After walking only a couple of blocks, Arlo tells us that we're here."
    time.sleep(3.5)
    print "You take a look around and see the only hospitible building in a block radius."
    time.sleep(4.5)
    print "The building has a sign just outside of it."
    time.sleep(2.5)
    print ""
    print "'Buffy's Stuffies' it reads."
    time.sleep(2.5)
    print ""
    print "'I see he got creative with the name.' you say jokingly."
    time.sleep(2.5)
    print ""
    print "Arlo lets out a nice chuckle."
    time.sleep(2.5)
    print ""
    print "'Well, Buffy is getting older now, not a lot of creative juice is left in him.' he explains."
    time.sleep(4.5)
    print "'Also, Buffy is from a different world, one where the economy was great and everyone was successful.'"
    time.sleep(4.5)
    print "'It's quite inspiring to see him push through all hardships like this."
    time.sleep(3.5)
    print ""
    print "Feeling touched by Arlo's explaination of Buffy, you go silent."
    time.sleep(3.5)
    print "Arlo then picks the conversation back up."
    time.sleep(2.5)
    print ""
    print "'Well, shall we go inside? I'm sure he'll be happy to see a new face around.'"
    time.sleep(3.5)
    print ""
    print "You nod your head in agreement and the two of you walk inside Buffy's Stuffies."
    time.sleep(4.5)
    print "Looking around the shop you see an assortment of hand tools, candies, and small pieces of art."
    time.sleep(4.5)
    print ""
    print "'He really has some random stuff here.' you think to yourself."
    time.sleep(3.5)
    print ""
    print "After passing all of the rows of 'stuffies' you can see an old man hunched over the counter."
    time.sleep(4.5)
    print ""
    print "'Buffy! How are you doing?' Arlo says with a raised voice."
    time.sleep(3.5)
    print ""
    print "The old man's eyes slowly open, but then, light up when he recognizes Arlo."
    time.sleep(3.5)
    print ""
    print "'Ahh, Arlo my boy! What brings you to my shop today?' Buffy asks."
    time.sleep(3.5)
    print ""
    print "'Well, I have a new friend I wanted you to meet.' Arlo replies."
    time.sleep(3.5)
    print "'You see, this young man, %s, fell from the sky not too long ago and now lost his memory.'" %(user_name)
    time.sleep(4.5)
    print ""
    print "'Oh how horrible and scary it must be!' Buffy comes from around the counter and grabs your hand with both of his."
    time.sleep(4.5)
    print ""
    print "'I was wanting to ask you Buffy,' Arlo continues,"
    time.sleep(2.5)
    print "'do you know anything about an airplane flying over Pitterton just about a week ago?'"
    time.sleep(3.5)
    print ""
    print "'An airplane? Let me think for a second.' Buffy looks a bit stumped until he jumps up with a burst of excitement."
    time.sleep(4.5)
    print "'It may not be what you're asking for, but there was a celebration of the newly constructed World Horizon around that time.'"
    time.sleep(4.5)
    print ""
    print "'World Horizon? What's that?' you inquire."
    time.sleep(2.5)
    print ""
    print "'The World Horizon is an engineering achievement like no other,' Buffy says,"
    time.sleep(3.5)
    print "'the worlds biggest commercial transport airship of all time.'"
    time.sleep(2.5)
    print "'They say that millionares from around the world came to see and fly on it.'"
    time.sleep(3.5)
    print ""
    print "'Wow, incredible, do you think you could've come from there %s?' Arlo asks." %(user_name)
    time.sleep(3.5)
    print ""
    print "'I have no idea, maybe I did. Am I a millionare?'"
    time.sleep(2.5)
    print ""
    print "Buffy and Arlo let out a tremendous laugh but don't say anything else."
    time.sleep(3.5)
    print "After they settle down Arlo picks up the conversation."
    time.sleep(2.5)
    print ""
    print "'Thanks a lot Buffy, but that's about all I had to ask of you.' he says."
    time.sleep(3.5)
    print "'We better get going now.'"
    time.sleep(2.5)
    print ""
    print "'Well, I hope you have a good day Arlo, as to you too %s.' Buffy says." %(user_name)
    time.sleep(3.5)
    print ""
    print "You thank Buffy for his help and the two of you walk back outside 'Buffy's Stuffies'."
    time.sleep(3.5)
